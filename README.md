...
1. REST Countries, https://restcountries.eu/<br/>
...
2. OpenWeather (heel origineel, ik weet het), https://openweathermap.org/current <br/>
...
Algemene informatie over de webpagina <br/>
